                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        <Input
                          ...
                          onChange={(e) => {
                            const newEducacion = [...formData.educacion]
                            newEducacion[index].año = Number.parseInt(e.target.value)
                            setFormData((prev) => ({ ...prev, educacion: newEducacion }))
                          }}
                        />
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          const newExperiencia = [...formData.experiencia]
                          newExperiencia[index].añoInicio = Number.parseInt(e.target.value)
                          setFormData((prev) => ({ ...prev, experiencia: newExperiencia }))
                        }}
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        <Input
                          ...
                          onChange={(e) => {
                            const newExperiencia = [...formData.experiencia]
                            newExperiencia[index].añoFin = e.target.value ? Number.parseInt(e.target.value) : undefined
                            setFormData((prev) => ({ ...prev, experiencia: newExperiencia }))
                          }}
                        />
