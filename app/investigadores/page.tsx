                  ...
                  <AnimatedCard className="h-full glass-effect card-hover cursor-pointer" delay={index * 100}>
                    <CardContent className="pt-4 sm:pt-6 px-3 sm:px-6">
                      <div className="flex flex-col items-center text-center">
                        ...
                        <h3 className="font-bold text-blue-900 mb-1 text-sm sm:text-base">{investigador.nombre || 'Sin nombre'}</h3>
                        <p className="text-blue-600 text-xs sm:text-sm mb-2">
                          {investigador.ultimoGradoEstudios || investigador.nivel || 'Investigador'}
                        </p>
                        {investigador.area && (
                          <AnimatedBadge variant="secondary" className="mb-2 sm:mb-3 bg-blue-50 text-blue-700 text-xs">
                            {investigador.area}
                          </AnimatedBadge>
                        )}
                        ...
                        <div className="w-full space-y-1.5 sm:space-y-2 text-xs sm:text-sm">
                          {investigador.institucion && investigador.institucion.trim() !== '' && (
                            <div className="flex items-center justify-center gap-1 text-blue-600">
                              ...
                              <span className="text-xs font-medium">{investigador.institucion}</span>
                              <Badge variant="secondary" className="bg-blue-100 text-blue-700 text-[10px] px-1.5 py-0 ml-1">
                                Registrado
                              </Badge>
                            </div>
                          )}
                    ...
                    <CardFooter className="border-t border-blue-100 flex justify-center py-2 sm:py-3 px-3 sm:px-6">
                      <div className="text-center">
                        <p className="text-[10px] sm:text-xs text-blue-600 break-all">{investigador.email || 'Sin email'}</p>
                      </div>
                    </CardFooter>
                  </AnimatedCard>
                </Link>
