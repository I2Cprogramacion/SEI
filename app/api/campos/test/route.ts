...
export async function GET() {
  try {
    ...
    const camposPrueba = [
      {
        ...
        subcampos: ["Inteligencia Artificial", "Machine Learning", "Algoritmos"],
      ...
      },
      {
        ...
        crecimiento: 65,
        tendencia: "up" as const,
        subcampos: ["Ingeniería Civil", "Ingeniería Industrial", "Mecánica"],
      ...
      },
      {
        id: 3,
        nombre: "Medicina",
        descripcion: "Área de investigación con 10 investigadores activos",
        investigadores: 10,
        proyectos: 5,
        publicaciones: 15,
        instituciones: 2,
        ...
        subcampos: ["Medicina Interna", "Cirugía", "Pediatría"],
        color: "bg-purple-100 text-purple-800",
        slug: "medicina",
        instituciones_lista: "UACH, Hospital General",
        dias_promedio_registro: 0
      }
    ]
    ...
    const estadisticas = {
      totalCampos: 3,
      totalInvestigadores: 37,
      totalProyectos: 19,
      totalPublicaciones: 58
    }
    
    const filtros = {
      instituciones: ["UACH", "UACJ", "ITCH", "Hospital General"],
      nivelesActividad: [
